...
class ScenesControllerTest < ActionController::TestCase
  ...
  test "should create scene" do
    assert_difference('Scene.count') do
      post :create, scene: { description: @scene.description, story_id: @scene.story_id, title: @scene.title }
    end
  ...
  test "should update scene" do
    patch :update, id: @scene, scene: { description: @scene.description, story_id: @scene.story_id, title: @scene.title }
    assert_redirected_to scene_path(assigns(:scene))
  end
